...
public class ShortVideoPlayer extends FrameLayout implements View.OnClickListener {
    ...
    public ShortVideoPlayer(AppCompatActivity context, AttributeSet attrs, int defStyleAttr) {
