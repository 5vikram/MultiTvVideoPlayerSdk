...
public final class CastPlayer extends BasePlayer {
  ...
  /**
   * Updates the timeline and notifies {@link Listener event listeners} if required.
   *
  ...
  private boolean updateTracksAndSelectionsAndNotifyIfChanged() {
    ...
    @Nullable TrackSelection[] trackSelections = new TrackSelection[RENDERER_COUNT];
    TracksInfo.TrackGroupInfo[] trackGroupInfos =
        new TracksInfo.TrackGroupInfo[castMediaTracks.size()];
    for (int i = 0; i < castMediaTracks.size(); i++) {
      MediaTrack mediaTrack = castMediaTracks.get(i);
      trackGroups[i] =
          new TrackGroup(CastUtils.mediaTrackToFormat(mediaTrack));
  ...
  private void updateAvailableCommandsAndNotifyIfChanged() {
    ...
    availableCommands = CastUtils.getAvailableCommands(/* player= */ this, PERMANENT_AVAILABLE_COMMANDS);
  ...
  private void setRepeatModeAndNotifyIfChanged(@RepeatMode int repeatMode) {
  ...
  private final class StatusListener extends RemoteMediaClient.Callback
    ...
    public void onSessionStarted(CastSession castSession, String s) {
      ...
      android.util.Log.e(TAG, "onSessionStarted: " + " getDeviceId " + castSession.getCastDevice().getDeviceId());
//      android.util.Log.e(TAG, "onSessionStarted: " + " cast id " + castSession.getCastDevice().toString());
      android.util.Log.e(TAG, "onSessionStarted: " + " getDeviceVersion " + castSession.getCastDevice().getDeviceVersion());
      android.util.Log.e(TAG, "onSessionStarted: " + " getFriendlyName " + castSession.getCastDevice().getFriendlyName());
      android.util.Log.e(TAG, "onSessionStarted: " + " getModelName " + castSession.getCastDevice().getModelName());
      android.util.Log.e(TAG, "onSessionStarted: " + " getInetAddress " + castSession.getCastDevice().getInetAddress());
      android.util.Log.e(TAG, "onSessionStarted: " + " isOnLocalNetwork " + castSession.getCastDevice().isOnLocalNetwork());
      android.util.Log.e(TAG, "onSessionStarted: " + " hasIPv4Address " + castSession.getCastDevice().hasIPv4Address());
      android.util.Log.e(TAG, "onSessionStarted: " + " hasIPv6Address " + castSession.getCastDevice().hasIPv6Address());
      android.util.Log.e(TAG, "onSessionStarted: " + " getServicePort " + castSession.getCastDevice().getServicePort());
